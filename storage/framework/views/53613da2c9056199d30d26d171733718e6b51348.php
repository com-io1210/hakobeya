								...
								<?php endif; ?>
									<div class="sd" room-block="">
										...
										<div class="sd image" room-image="">
											<img src="<?php echo e($r->image); ?>" style="width: 100%;">
										</div>
										<h3 class="sd text" room-title=""><?php echo e($r->title); ?></h3>
										<div class="sd" type-tag-block="">
											<?php $__currentLoopData = $r->type_tag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php if($t): ?>
											<div class="sd" type-tag=""><?php echo e($t); ?></div>
												<?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\hakobeya\resources\views/index.blade.php ENDPATH**/ ?>