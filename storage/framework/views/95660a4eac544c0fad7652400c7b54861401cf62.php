  ...
  <form method="post" action="/admin/roommodel/create" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <select name="room_id" id="room_idInput">
        ...
        <option value=<?php echo e($room->id); ?>><?php echo e($room->title); ?></option>
    ...
    <div class="form-group">
      ...
      <br>
      <p style="color:red;"><?php echo e($errors->first('furniture_model')); ?></p>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\hakobeya\resources\views/admin/RoomModel/create.blade.php ENDPATH**/ ?>