...
<body class="p-3">
  ...
  <form method="post" action="/room/create">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="seo_tagInput" rows="3" name="seo_tag"></textarea>
    </div>
    <div class="form-group">
      ...
      <input type="checkbox" name="breadthCheck" value="<?php echo e($breadthCheck['breadth_id']); ?>"> <?php echo e($breadthCheck['breadth_name']); ?>
...
</html><?php /**PATH C:\xampp\htdocs\hakobeya\resources\views/Room/create.blade.php ENDPATH**/ ?>