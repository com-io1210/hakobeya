...
<body class="p-3">
  ...
  <form method="post" action="/admin/furnituremodel/create" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <br>
      <p style="color:red;"><?php echo e($errors->first('genle')); ?></p>
    ...
    <div class="form-group">
      ...
      <br>
      <p style="color:red;"><?php echo e($errors->first('search_word')); ?></p>
    </div>
    <div class="form-group">
      <label for="titleInput">アフィリンク表示件数</label>
      <input type="text" class="form-control" id="numberInput" name="number">
      <br>
      <p style="color:red;"><?php echo e($errors->first('number')); ?></p>
    </div>
    <div class="form-group">
...
</html><?php /**PATH C:\xampp\htdocs\hakobeya\resources\views/admin/FurnitureModel/create.blade.php ENDPATH**/ ?>